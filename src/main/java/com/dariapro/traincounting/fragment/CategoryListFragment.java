...
public class CategoryListFragment extends Fragment {
    ...
    private void updateUI(){
        ...
        if(adapter == null){
            adapter = new RecipeAdapter(categories);
...
//            startActivityForResult(intent,REQUEST_EVENT);
    ...
    private class RecipeAdapter extends RecyclerView.Adapter<CategoryHolder>{

        private List<Category> categories;

        public RecipeAdapter(List<Category> categories) {
        ...
        public void setRecipes(List<Category> categories){
